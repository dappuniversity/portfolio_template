    ...
    <section className="projects">
      ...
      <div className="projects__card">
          ...
          <div className="card-buttons">
            <a href="https://damonpickett.github.io/crypto-voting-dapp/" target="_blank" rel='noreferrer' className="button">
              Site
            </a>
            <a
      ...
      <div className="projects__card">
        ...
        <div className="projects__card">
          ...
          <div className="card-buttons">
            <a href="https://damonpickett.github.io/sffpc/#/" target="_blank" rel='noreferrer' className="button">
              Site
            </a>
            <a
        ...
        <div className="projects__card">
          ...
          <div className="card-buttons">
            <a href="https://damonpickett.github.io/whitsteen-project/" target="_blank" rel='noreferrer' className="button">
              Site
            </a>
            <a
